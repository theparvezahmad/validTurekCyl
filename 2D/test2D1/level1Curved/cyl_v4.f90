...
!----------------------------------------------------------------------
  ...
  write (10, *) "Variables=timeReal,timeLBM,rho,Cd,Cl"
        ...
        if (isn(i, j) .eq. 0) then
          ...
          do a = 0, q - 1
            ...
            if (isn(ia, ja) .eq. 1) then !structure
              ...
              ! fx(2) = fx(2) + ex(a)*(ft(kb(a), i, j) + ft(a, ia, ja))
              ! fy(2) = fy(2) + ey(a)*(ft(kb(a), i, j) + ft(a, ia, ja))
