...
set ylabel "Cd"
set output 'drag.pdf'
plot "tRhoCdCl.dat" every ::180001::200000 u 1:4 title "Present Drag" w l #ls 1#, Ref_Drag title "Benchmark Drag" ls 2 dashtype "-"

# Ref_Lift=10.53
set ylabel "Cl"
set output 'lift.pdf'
plot "tRhoCdCl.dat" every ::180001::200000 u 1:5 title "Present Lift" w l #ls 1#, Ref_Lift title "Benchmark Lift" ls 2 dashtype "-"

stats "tRhoCdCl.dat" every ::180001::200000 u 4
stats "tRhoCdCl.dat" every ::180001::200000 u 5