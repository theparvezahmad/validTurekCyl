...
# set ylabel "Cd"
# set output 'drag.png'
# plot "tRhoCdCl.dat" every ::80000::90000 u 1:4 title "Present Drag" w l ls 1#, Ref_Drag title "Benchmark Drag" ls 2 dashtype "-"

# # Ref_Lift=10.53
# set ylabel "Cl"
# set output 'lift.png'
# plot "tRhoCdCl.dat" every ::80000::90000 u 1:5 title "Present Lift" w l ls 1#, Ref_Lift title "Benchmark Lift" ls 2 dashtype "-"
...
set ylabel "Cd"
set output 'drag.pdf'
plot "tRhoCdCl.dat" every ::yS::yE u 2:4 title "Present Drag" w l #ls 1#, Ref_Drag title "Benchmark Drag" ls 2 dashtype "-"

# Ref_Lift=10.53
set ylabel "Cl"
set output 'lift.pdf'
plot "tRhoCdCl.dat" every ::yS::yE u 2:5 title "Present Lift" w l #ls 1#, Ref_Lift title "Benchmark Lift" ls 2 dashtype "-"

stats "tRhoCdCl.dat" every ::yS::yE u 4 name 'Drag' #nooutput
print "-------------------------------------------"
stats "tRhoCdCl.dat" every ::yS::yE u 5 name 'Lift' #nooutput

set print "gnuStats.txt"
print "Min/Max Lift: ", Lift_min, Lift_max
print "Min/Max Drag: ", Drag_min, Drag_max
# show variables
